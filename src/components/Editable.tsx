...
export const SvgEditable = (props: IIblisReactUndrawProps & SVGProps<SVGSVGElement>) => (
  <svg
    data-name="Layer 1"
    ...
    {...props}
  >
    <path fill={props.accentcolor} d="M446.31 0l296.284 120.895-71.781 175.92-296.284-120.896z" />
    <circle cx={505.03} cy={128.724} r={72} fill={props.primarycolor} />
    <path fill={props.primarycolor} d="M617.376 102.203l22.222 9.067-9.068 22.222-22.22-9.068z" />
    <path fill={props.primarycolor} opacity={0.5} d="M645.152 113.537l22.222 9.067-9.067 22.221-22.222-9.067z" />
    <path fill={props.primarycolor} opacity={0.2} d="M672.93 124.87l22.22 9.067-9.066 22.222-22.222-9.068z" />
    <path fill={props.haircolor} d="M606.043 129.98l22.22 9.066-9.066 22.222-22.222-9.068z" />
    <path fill={props.haircolor} opacity={0.5} d="M633.819 141.313l22.22 9.067-9.066 22.221-22.222-9.067z" />
    <path fill={props.haircolor} opacity={0.2} d="M661.595 152.647l22.222 9.067-9.067 22.221-22.222-9.067z" />
    <path fill="#ff6584" d="M594.708 157.756l22.222 9.067-9.067 22.222-22.222-9.068z" />
    <path fill="#ff6584" opacity={0.5} d="M622.485 169.09l22.222 9.067-9.067 22.222-22.222-9.067z" />
    <path fill="#ff6584" opacity={0.2} d="M650.261 180.424l22.222 9.067-9.067 22.221-22.222-9.067z" />
    <path
    ...
    />
    <circle cx={172.607} cy={474.272} r={18.886} fill={props.accentcolor} />
    <path
    ...
    <circle cx={514.807} cy={268.599} r={29.385} fill={props.haircolor} />
    <path
    ...
    />
    <circle cx={515.136} cy={279.342} r={19.826} fill={props.skincolor} />
    <path
    ...
    <path
      ...
      fill={props.accentcolor}
    />
    <circle cx={504.528} cy={237.671} r={12.159} fill={props.haircolor} />
    <path
      ...
      fill={props.haircolor}
    />
    <ellipse cx={518.225} cy={262.368} rx={20.265} ry={12.159} fill={props.haircolor} />
    <path
