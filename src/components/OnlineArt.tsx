...
export const SvgOnlineArt = (props: IIblisReactUndrawProps & SVGProps<SVGSVGElement>) => (
  <svg
    data-name="Layer 1"
  ...
  >
    ...
    <path
      ...
      fill="#f2f2f2"
    />
    <circle cx={394.75} cy={186.291} r={4.841} fill={props.primarycolor} />
    <circle cx={385.337} cy={225.018} r={2.689} fill={props.primarycolor} />
    <circle cx={352.527} cy={198.394} r={2.689} fill={props.accentcolor} />
    <circle cx={447.461} cy={172.307} r={2.689} fill={props.accentcolor} />
    <circle cx={366.512} cy={223.674} r={2.689} fill={props.accentcolor} />
    <circle cx={422.988} cy={208.075} r={2.689} fill={props.accentcolor} />
    <circle cx={368.125} cy={263.207} r={2.689} fill={props.accentcolor} />
    <circle cx={425.678} cy={247.878} r={2.689} fill={props.accentcolor} />
    <circle cx={399.591} cy={250.567} r={2.689} fill={props.primarycolor} />
    <path
    ...
    <path d="M885.5 77.401s16 43 25 47 25 23 25 23 2 50-9 50-72-71-72-71 3-14-3-22 34-27 34-27z" fill="#a0616a" />
    <path
    ...
    <path
      ...
      fill="#d0cde1"
    />
    <path d="M856.5 174.401s-4 66-15 78-55 62-55 62l-2 12-10 7s-10-24 1-34l38-68 9-64z" fill="#a0616a" />
    <path d="M825.5 122.401s23.316-13.474 29.658-1.237S858.5 182.4 858.5 182.4l-42-5s3-54 9-55z" fill="#d0cde1" />
    <path
