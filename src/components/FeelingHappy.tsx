...
export const SvgFeelingHappy = (props: IIblisReactUndrawProps & SVGProps<SVGSVGElement>) => (
  <svg data-name="Layer 1" viewBox="0 0 644 673" className={props.class} width="100%" height={props.height} {...props}>
