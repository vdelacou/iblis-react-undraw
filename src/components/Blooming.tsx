...
export const SvgBlooming = (props: IIblisReactUndrawProps & SVGProps<SVGSVGElement>) => (
  <svg data-name="Layer 1" viewBox="0 0 752 651" className={props.class} width="100%" height={props.height} {...props}>
