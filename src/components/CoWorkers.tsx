...
export const SvgCoWorkers = (props: IIblisReactUndrawProps & SVGProps<SVGSVGElement>) => (
  <svg
    data-name="Layer 1"
  ...
  >
    ...
    <g opacity={0.7}>
      ...
      <path
        ...
        transform="translate(-105 -70.89)"
        fill="url(#CoWorkers_svg__i)"
      />
      <path fill="url(#CoWorkers_svg__j)" d="M359.21 288.72l16.36 79.41-26.7 13.49-14.63-71.53 24.97-21.37z" />
      <path fill="url(#CoWorkers_svg__k)" d="M404.05 374l12.46-51.04 16.03 29.92-8.31 24.64-20.18-3.52z" />
      <path
        d="M554.15 460.14s0 79.78 10.68 85.64"
        transform="translate(-105 -70.89)"
        opacity={0.1}
        fill="url(#CoWorkers_svg__l)"
      />
      <path
        d="M401.05 480.08s-24.63 78.57-17.66 86.8"
        transform="translate(-105 -70.89)"
        opacity={0.1}
        fill="url(#CoWorkers_svg__m)"
      />
      <path
        d="M396.31 588s47.48 30.69 54 31.18"
        transform="translate(-105 -70.89)"
        opacity={0.1}
        fill="url(#CoWorkers_svg__n)"
      />
      <path
        ...
        transform="translate(-105 -70.89)"
        fill="url(#CoWorkers_svg__o)"
        opacity={0.1}
      />
      <ellipse cx={410.58} cy={258.44} rx={54.59} ry={53.97} fill="url(#CoWorkers_svg__p)" />
      <path
      ...
      <path
        ...
        transform="translate(-105 -70.89)"
        fill="url(#CoWorkers_svg__s)"
        opacity={0.1}
      />
      <path
        d="M506.14 337.79c-.8 5.58-2.58 15.24-5.93 21.34a170.66 170.66 0 00-11.33 24.76s21.86 16.73 33 28.16a25.92 25.92 0 0027.22 6.59c5.79-2.08 10.86-6.1 12.21-13.64 2.12-11.89-.4-20.86-2.78-26.17a19.45 19.45 0 01-.08-16c.82-1.8 1.78-3.21 2.85-3.56 0 0-21.36-4.69-22.55 1.17s-17.8 11.73-21.36 1.17l-1-23.28a5.12 5.12 0 00-5.14-4.88 5.12 5.12 0 00-5.11 4.34z"
        transform="translate(-105 -70.89)"
        fill="url(#CoWorkers_svg__t)"
      />
    </g>
    <path
    ...
    <path
      ...
      fill={props.primarycolor}
    />
    <path d="M624.61 492.76a201.83 201.83 0 0152.39-6.84M742 431.24s-17.09 12.53-12.53 19.37" opacity={0.1} />
    <path
      fill="url(#CoWorkers_svg__v)"
