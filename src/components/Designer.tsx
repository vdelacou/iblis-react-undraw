...
export const SvgDesigner = (props: IIblisReactUndrawProps & SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <rect x={68.053} y={573.241} width={106.916} height={45.496} rx={15.198} fill={props.primarycolor} />
    <path
    ...
    <path
      ...
      fill="#fda57d"
    />
    <path d="M449.43 289.434a107.19 107.19 0 0074.478.206v-9.15h-74.479z" opacity={0.1} />
    <circle cx={486.807} cy={187.668} r={106.753} fill="#fda57d" />
    <path d="M410.766 90.565s44.99 91.323 171.902 38.275l-29.546-46.333-52.376-18.802z" opacity={0.1} />
    <path d="M410.766 89.222s44.99 91.323 171.902 38.275l-29.546-46.333-52.376-18.802z" fill="#72351c" />
    <path
