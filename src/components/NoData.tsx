...
export const SvgNoData = (props: IIblisReactUndrawProps & SVGProps<SVGSVGElement>) => (
  <svg
    data-name="Layer 1"
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        xlinkHref="#NoData_svg__a"
      />
      <linearGradient id="NoData_svg__d" x1={476.4} y1={710.53} x2={476.4} y2={127.12} xlinkHref="#NoData_svg__a" />
      <linearGradient id="NoData_svg__e" x1={476.94} y1={156.13} x2={476.94} y2={106.68} xlinkHref="#NoData_svg__a" />
      <linearGradient id="NoData_svg__f" x1={666.86} y1={176.39} x2={666.86} y2={117.95} xlinkHref="#NoData_svg__a" />
    </defs>
    ...
    />
    <path fill={props.primarycolor} d="M183.007 98.422L378.4 56.498l9.917 46.218-195.393 41.924z" />
    <path
    ...
    <path fill="url(#NoData_svg__d)" d="M265.28 127.12h422.25v583.41H265.28z" opacity={0.5} />
    <path fill="#fff" d="M270.65 131.42h411.5v570.52h-411.5z" />
    <path fill="url(#NoData_svg__e)" d="M374.87 106.68h204.14v49.45H374.87z" />
    <path
